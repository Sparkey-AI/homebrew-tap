class Sparkey < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://install.sparkey.ai/v0.5.24/sparkey-darwin-arm64"
      sha256 "935f5f33ee0f56783d1a709fc9d71846649ed5db91ebf7446b7b95c622a70f1d"
    else
      url "https://install.sparkey.ai/v0.5.24/sparkey-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://install.sparkey.ai/v0.5.24/sparkey-linux-arm64"
      sha256 "f5e4389009b27ba64405d8bf1c2015567413fa2890175c57b9d38cba0cfcb329"
    else
      url "https://install.sparkey.ai/v0.5.24/sparkey-linux-x64"
